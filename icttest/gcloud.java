...
public class gcloud {
	...
	private static String getPapago(String src) {
		...
		String g = "{  \"data\": {    \"translations\": [      {        \"translatedText\": \"Chicken ribs alley\"      }    ]  }}";
        
        try {
            String text = URLEncoder.encode(src, "UTF-8");
            String apiURL = "https://translation.googleapis.com/language/translate/v2?q="+text+"&source=ko&target=en&format=text&key=AIzaSyAuFeO7ux6rmnbxV4-RegZJawc16Wok4J0";
            ...
            //JsonObject message = json.getAsJsonObject("data");
            ...
            strResult = translations.getAsJsonArray().get(0).getAsJsonObject().get("translatedText").toString().replaceAll("\"", "").replaceAll("\'", "\''");
